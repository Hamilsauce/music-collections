...
export class FSFileSystemModel {
  constructor(store) {
    this.store = store;
    this.request$ = new BehaviorSubject(['8y17ynkbytusbghytq'])
    .pipe(
    ...
    // console.log('this.store', [...this._rootFolder.children])
    setTimeout(() => {
      // console.log('FILE rootFolder', this.rootFolder);
      // console.log('FILE SYS', this);
    }, 1000)
  }
